  ...
  return (
    <div className="space-y-6 relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center">
          <label className="flex items-center">
            <input
              ...
              onChange={handleChange}
              className="form-checkbox h-5 w-5 text-amber-600 bg-[#b1dd4b] border-amber-400 rounded focus:ring-amber-600"
            />
        ...
        <button
          type="submit"
          className="w-full py-3 bg-gradient-to-r from-amber-400 to-green-600 text-[#07120a] font-bold rounded-lg flex items-center justify-center gap-2 hover:scale-105 transition-transform"
        >
